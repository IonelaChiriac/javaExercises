...
public class Exercise8Date {
    ...
    public Exercise8Date(int month, int day, int year) {
        ...
        if (month == 2 && day == 29 && !(year % 400 == 0 || (year % 4 == 0 && year % 100 != 0)))
            throw new IllegalArgumentException("day (" + day + ") out-of-range for the specified month and year");
        if (year < 0) throw new IllegalArgumentException("year (" + year + ") must be" + "greater than 0");
