...
//9.14 (Employee Hierarchy)
// In this chapter, you studied an inheritance hierarchy in which
// class BasePlusCommissionEmployee inherited from class CommissionEmployee.
// However, not all types of employees are CommissionEmployees.
// In this exercise, you’ll create a more general Employee superclass
...
// Class CommissionEmployee’s constructor should invoke class Employee’s constructor
// and CommissionEmployee’s toString method should invoke Employee’s toString method.
// Once you’ve completed these modifications, run the CommissionEmployeeTest and BasePlusCommissionEmployeeTest
// apps using these new classes to ensure that the apps still display the same results
// for a CommissionEmployee object and BasePlusCommissionEmployee object, respectively.
public class Exercise14CommissionEmployeeTest {
    public static void main(String[] args) {
        // instantiate CommissionEmployee object
        Exercise14CommissionEmployee employee = new Exercise14CommissionEmployee("Sue", "Jones", "222-22-2222", 10000, .06);
