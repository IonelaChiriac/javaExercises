...
// Write an application that inputs an integer containing only 0s and 1s
// (i.e., a binary integer) and prints its decimal equivalent.
...
//digit to the left a positional value of 10, then 100, then 1000, and so on.
